...
namespace AI.Planner.Domains
{
    public struct GoalComplete
    {
        ...
        {
            var NPCFilter = new NativeArray<ComponentType>(3, Allocator.Temp){[0] = ComponentType.ReadWrite<Npc>(),[1] = ComponentType.ReadWrite<Location>(),[2] = ComponentType.ReadWrite<Baggage>(),  };
